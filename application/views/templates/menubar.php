              ...
              <div class="search-item">
                ...
                <ul class="navbar-nav navbar-right">
                            ...
                            <div class="dropdown-list-content dropdown-list-message">
                                <a href="#" class="dropdown-item dropdown-item-unread">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image" src="<?= base_url(); ?>assets/template/img/avatar/avatar-1.png" class="rounded-circle">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <img alt="image" src="<?= base_url(); ?>assets/template/img/avatar/avatar-1.png" class="rounded-circle mr-1">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="<?= base_url(); ?>auth/dologout" class="dropdown-item has-icon text-danger">
                  ...
                  <li><a class="nav-link" href="index.html">Ecommerce Dashboard</a></li>
                            ...
                            <?php foreach ($subMenu as $sm) : ?>
                                <?php if ($title == $sm['title']) : ?>
                                    ...
                                    <a class="nav-link" href="<?= base_url($sm['url']); ?>"><i class="<?= $sm['icon']; ?>"></i> <span><?= $sm['title']; ?></span></a>
